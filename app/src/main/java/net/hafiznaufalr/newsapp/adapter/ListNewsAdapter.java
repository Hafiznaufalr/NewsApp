package net.hafiznaufalr.newsapp.adapter;
...
import net.hafiznaufalr.newsapp.DetailArticle;
import net.hafiznaufalr.newsapp.Interface.ItemClickListener;
import net.hafiznaufalr.newsapp.ListNews;
import net.hafiznaufalr.newsapp.R;
import net.hafiznaufalr.newsapp.common.ISO8601Parse;
...
class ListNewsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ...
    public ListNewsViewHolder(@NonNull View itemView, ItemClickListener itemClickListener) {
        super(itemView);
        this.itemClickListener = itemClickListener;
    }
